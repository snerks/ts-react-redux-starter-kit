...
import { HomeView, HomeViewProps, mapStateToProps } from '../../src/views/HomeView/HomeView';
...
function renderWithProps(props: HomeViewProps): React.Component<any, any> {
    'use strict';

    return TestUtils.renderIntoDocument(<HomeView {...props} />);
}

function shallowRenderWithProps(props: HomeViewProps): React.ReactElement<any> {
    'use strict';
...
describe('(View) Home', () => {
  ...
  beforeEach(() => {
      ...
      const actionCreators: HomeViewProps = {
          counter: 0,
